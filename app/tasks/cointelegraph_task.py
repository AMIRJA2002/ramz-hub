"""Celery task for Cointelegraph crawler"""
...
@celery_app.task(name="app.celery_app.crawl_cointelegraph", bind=True)
def crawl_cointelegraph(self):
    """Celery task to crawl Cointelegraph"""
